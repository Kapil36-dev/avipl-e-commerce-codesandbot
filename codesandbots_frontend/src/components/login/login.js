...
function Login() {
    ...
    const submitlogin = (e) => {
        ...
        if (Object.keys(data).length === 0) {
            ...
            axioss({ method: 'post', url: '/login', data: newuser }).then((res) => {
                ...
                console.log(err);
                setsuccess("USER NOT SUCCESSFULLY LOGIN");
                setstatus(true)
                setTimeout(() => {
                    setsuccess("")
                    setstatus(false)
    ...
    const register = (e) => {
        ...
        seterror(data);
        if (Object.keys(data).length === 0) {
            const newentry = { email: email, password: password, name: Name, confirm_password: confirmpassword }
                    ...
                    <div className="right-signup">
                        ...
                        <div className="form-panel">
                            <form action="" className='form' onSubmit={register}>
                                ...
                                <div>
                                    {error.password ?
                                        <input type="" placeholder="Password" value={password} style={{ borderBottomColor: "red" }} onChange={(e) => setpassword(e.target.value)} /> :
                                ...
                                <div>
                                    {error.confirmpassword ?
                                        <input type="" placeholder="Confirm Password" style={{ borderBottomColor: "red" }} value={confirmpassword} onChange={(e) => setconfirmpassword(e.target.value)} /> :
